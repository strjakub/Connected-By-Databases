...
case class tourData(name:String, place:String,date:Date,teams:List[String],games:List[String])
case class gameData(team1Id:String, team2Id:String,result:String,date:LocalDateTime,refereeId:String, scorers:List[String])
